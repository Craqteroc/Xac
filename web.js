...
;
	($.$xac_menu_menupage) = class $xac_menu_menupage extends ($.$mol_example_large) {
		Spread_close(){
			return (this.Calatog().Spread_close());
		}
		Foods_spread_close(){
			return (this.Item1().Spread_close());
		}
		Pizza(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Первый");
		...
		Item1(){
			...
			(obj.param) = () => ("mol_book2_catalog_item1");
			(obj.menu_title) = () => ("Первый");
		...
		Calatog(){
			const obj = new this.$.$mol_book2_catalog();
			(obj.param) = () => ("mol_book2_catalog");
			(obj.menu_title) = () => ("Каталог");
			(obj.spreads) = () => ({"item1": (this.Item1()), "animals": (this.Animals())});
			return obj;
		}
		title(){
	...
	($mol_mem(($.$xac_menu_menupage.prototype), "Pizza"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Hot_dogs"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Fries"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Item1"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Cats"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Dogs"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Horses"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Racoons"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Pigs"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Rabbits"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Wolfs"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Mice"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Ants"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Bugs"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Animals"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Calatog"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Content"));
	($mol_mem(($.$xac_menu_menupage.prototype), "Empty"));
...
;
	($.$xac_menu) = class $xac_menu extends ($.$mol_page) {
		Form(){
			const obj = new this.$.$xac_menu_menupage();
			return obj;
		}
		body(){
			return [(this.Form())];
	...
	($mol_mem(($.$xac_menu.prototype), "Form"));
